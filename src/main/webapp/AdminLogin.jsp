...
<body>
<div class="container-fluid" style="display:inline;position:absolute;width:100%;height:80%">
  <img src="assets/images/lib.jpg" style="padding-top:0" alt="Book" width=100%>
